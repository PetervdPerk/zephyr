...
i.MX8M Mini LPDDR4 NavQ board is based on NXP i.MX8M Mini applications
...
The Zephyr mimx8mm_navq board configuration supports the following hardware
features:
...
:zephyr_file:`boards/arm/mimx8mm_navq/mimx8mm_navq_defconfig`.
...
MIMX8MM NavQ board was tested with the following pinmux controller
configuration.
...
The MIMX8MM NavQ board doesn't have QSPI flash for the M4 and it needs
...
configuration is done in the file ``boards/arm/mimx8mm_navq/mimx8mm_navq.dts``
...
MIMX8MM NavQ board can be debugged by connecting an external JLink
...
.. code-block:: console
   ...
   ***** Booting Zephyr OS build zephyr-v2.0.0-1859-g292afe8533c0 *****
   Hello World! mimx8mm_navq

References
==========

.. _NXP website:
   https://www.nxp.com/design/development-boards/i.mx-evaluation-and-development-boards/evaluation-kit-for-thebr-i.mx-8m-mini-applications-processor
